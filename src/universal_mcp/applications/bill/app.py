...
class BillApp(APIApplication):
    ...
    async def create_customer_attachment(self, customerId: str, name: str, items: list[bytes]) -> dict[str, Any]:
        ...
        response = await self._apost(url, data=request_body_data, params=query_params, content_type='application/octet-stream')
        return self._handle_response(response)
    ...
    async def list_bills(self, max: int | None=None, sort: str | None=None, filters: str | None=None, page: str | None=None) -> dict[str, Any]:
        """
        Get list of bills
    ...
    async def create_bill(self, vendorId: str, dueDate: str, billLineItems: list[dict[str, Any]], invoice: Any, description: str | None=None, payFromChartOfAccountId: str | None=None, classifications: Any | None=None) -> dict[str, Any]:
        """
        Create a bill
        ...
        """
        request_body_data = None
        request_body_data = {'vendorId': vendorId, 'description': description, 'dueDate': dueDate, 'billLineItems': billLineItems, 'invoice': invoice, 'payFromChartOfAccountId': payFromChartOfAccountId, 'classifications': classifications}
    ...
    async def replace_bill(self, billId: str, vendorId: str, dueDate: str, billLineItems: list[dict[str, Any]], invoice: Any, description: str | None=None, payFromChartOfAccountId: str | None=None, classifications: Any | None=None) -> dict[str, Any]:
        """
        Replace a bill
    ...
    async def update_bill(self, billId: str, vendorId: str | None=None, description: str | None=None, dueDate: str | None=None, billLineItems: list[dict[str, Any]] | None=None, invoice: Any | None=None, payFromChartOfAccountId: str | None=None, classifications: Any | None=None) -> dict[str, Any]:
        """
        Update a bill
    ...
    async def list_classification_accounting_classes(self, max: int | None=None, sort: str | None=None, filters: str | None=None, page: str | None=None) -> dict[str, Any]:
        """
    ...
    async def create_classification_accounting_class(self, name: str | None=None, shortName: str | None=None, description: str | None=None, parentId: str | None=None) -> dict[str, Any]:
        """
    ...
    async def update_classification_accounting_class(self, id: str, name: str | None=None, shortName: str | None=None, description: str | None=None, parentId: str | None=None) -> dict[str, Any]:
        """
    ...
    async def list_classification_chart_of_accounts(self, max: int | None=None, sort: str | None=None, filters: str | None=None, page: str | None=None) -> dict[str, Any]:
        """
    ...
    async def create_classification_chart_of_accounts(self, name: str, description: str | None=None, parentId: str | None=None, account: Any | None=None) -> dict[str, Any]:
        """
    ...
    async def update_classification_chart_of_accounts(self, id: str, name: str | None=None, description: str | None=None, parentId: str | None=None, account: Any | None=None) -> dict[str, Any]:
        """
    ...
    async def list_classification_departments(self, max: int | None=None, sort: str | None=None, filters: str | None=None, page: str | None=None) -> dict[str, Any]:
        """
    ...
    async def create_classification_department(self, name: str, shortName: str | None=None, description: str | None=None, parentId: str | None=None) -> dict[str, Any]:
        """
        Create a department
    ...
    async def update_classification_department(self, id: str, name: str | None=None, shortName: str | None=None, description: str | None=None, parentId: str | None=None) -> dict[str, Any]:
        """
        Update a department
    ...
    async def list_classification_employees(self, max: int | None=None, sort: str | None=None, filters: str | None=None, page: str | None=None) -> dict[str, Any]:
        """
    ...
    async def create_classification_employee(self, firstName: str | None=None, lastName: str | None=None, shortName: str | None=None, parentId: str | None=None) -> dict[str, Any]:
        """
        Create an employee
    ...
    async def update_classification_employee(self, id: str, firstName: str | None=None, lastName: str | None=None, shortName: str | None=None, parentId: str | None=None) -> dict[str, Any]:
        """
        Update an employee
    ...
    async def list_classification_items(self, max: int | None=None, sort: str | None=None, filters: str | None=None, page: str | None=None) -> dict[str, Any]:
        """
        Get list of items
    ...
    async def create_classification_item(self, type: Any, name: str, shortName: str | None=None, description: str | None=None, parentId: str | None=None, price: float | None=None, expenseChartOfAccountId: str | None=None, purchaseDescription: str | None=None, purchaseCost: float | None=None, chartOfAccountId: str | None=None, taxable: bool | None=None) -> dict[str, Any]:
        """
        Create an item
        ...
        """
        request_body_data = None
        request_body_data = {'type': type, 'shortName': shortName, 'name': name, 'description': description, 'parentId': parentId, 'price': price, 'expenseChartOfAccountId': expenseChartOfAccountId, 'purchaseDescription': purchaseDescription, 'purchaseCost': purchaseCost, 'chartOfAccountId': chartOfAccountId, 'taxable': taxable}
        request_body_data = {k: v for k, v in request_body_data.items() if v is not None}
        url = f'{self.base_url}/v3/classifications/items'
        query_params = {}
        response = await self._apost(url, data=request_body_data, params=query_params, content_type='application/json')
    ...
    async def update_classification_item(self, id: str, type: Any | None=None, shortName: str | None=None, name: str | None=None, description: str | None=None, parentId: str | None=None, price: float | None=None, expenseChartOfAccountId: str | None=None, purchaseDescription: str | None=None, purchaseCost: float | None=None, chartOfAccountId: str | None=None, taxable: bool | None=None) -> dict[str, Any]:
        """
        Update an item
    ...
    async def list_classification_jobs(self, max: int | None=None, sort: str | None=None, filters: str | None=None, page: str | None=None) -> dict[str, Any]:
        """
        Get list of jobs
    ...
    async def create_classification_job(self, name: str | None=None, shortName: str | None=None, description: str | None=None, parentId: str | None=None) -> dict[str, Any]:
        """
        Create a job
    ...
    async def update_classification_job(self, id: str, name: str | None=None, shortName: str | None=None, description: str | None=None, parentId: str | None=None) -> dict[str, Any]:
        """
        Update a job
    ...
    async def list_classification_locations(self, max: int | None=None, sort: str | None=None, filters: str | None=None, page: str | None=None) -> dict[str, Any]:
        """
    ...
    async def create_classification_location(self, name: str | None=None, shortName: str | None=None, description: str | None=None, parentId: str | None=None) -> dict[str, Any]:
        """
        Create a location
    ...
    async def update_classification_location(self, id: str, name: str | None=None, shortName: str | None=None, description: str | None=None, parentId: str | None=None) -> dict[str, Any]:
        """
        Update a location
    ...
    async def list_customers(self, max: int | None=None, sort: str | None=None, filters: str | None=None, page: str | None=None) -> dict[str, Any]:
        """
    ...
    async def create_customer(self, name: str, email: str, companyName: str | None=None, contact: Any | None=None, phone: str | None=None, fax: str | None=None, description: str | None=None, invoiceCurrency: Any | None=None, accountType: Any | None=None, paymentTermId: str | None=None, accountNumber: str | None=None, billingAddress: Any | None=None, shippingAddress: Any | None=None) -> dict[str, Any]:
        """
        Create a customer
        ...
        """
        request_body_data = None
        request_body_data = {'name': name, 'companyName': companyName, 'contact': contact, 'email': email, 'phone': phone, 'fax': fax, 'description': description, 'invoiceCurrency': invoiceCurrency, 'accountType': accountType, 'paymentTermId': paymentTermId, 'accountNumber': accountNumber, 'billingAddress': billingAddress, 'shippingAddress': shippingAddress}
        request_body_data = {k: v for k, v in request_body_data.items() if v is not None}
        url = f'{self.base_url}/v3/customers'
        query_params = {}
        response = await self._apost(url, data=request_body_data, params=query_params, content_type='application/json')
    ...
    async def update_customer(self, customerId: str, name: str | None=None, companyName: str | None=None, contact: Any | None=None, email: str | None=None, phone: str | None=None, fax: str | None=None, description: str | None=None, invoiceCurrency: Any | None=None, accountType: Any | None=None, paymentTermId: str | None=None, accountNumber: str | None=None, billingAddress: Any | None=None, shippingAddress: Any | None=None) -> dict[str, Any]:
        """
        Update a customer
    ...
    async def list_bank_accounts(self, max: int | None=None, sort: str | None=None, filters: str | None=None, page: str | None=None) -> dict[str, Any]:
        """
    ...
    async def create_bank_account(self, nameOnAccount: str, type: Any, ownerType: Any, bankName: str, routingNumber: str | None=None, accountNumber: str | None=None, accessToAdmins: bool | None=None, chartOfAccountId: str | None=None) -> dict[str, Any]:
        """
        ...
        """
        request_body_data = None
        request_body_data = {'nameOnAccount': nameOnAccount, 'routingNumber': routingNumber, 'accountNumber': accountNumber, 'type': type, 'ownerType': ownerType, 'bankName': bankName, 'accessToAdmins': accessToAdmins, 'chartOfAccountId': chartOfAccountId}
        request_body_data = {k: v for k, v in request_body_data.items() if v is not None}
        url = f'{self.base_url}/v3/funding-accounts/banks'
        query_params = {}
        response = await self._apost(url, data=request_body_data, params=query_params, content_type='application/json')
    ...
    async def list_bank_account_users(self, max: int | None=None, sort: str | None=None, filters: str | None=None, page: str | None=None, currentUser: bool | None=None) -> dict[str, Any]:
        """
    ...
    async def update_bank_account(self, bankAccountId: str, nameOnAccount: str | None=None, ownerType: Any | None=None, bankName: str | None=None, accessToAdmins: bool | None=None, default: Any | None=None, chartOfAccountId: str | None=None) -> dict[str, Any]:
        """
        ...
        if bankAccountId is None:
            raise ValueError("Missing required parameter 'bankAccountId'.")
        request_body_data = None
        request_body_data = {'nameOnAccount': nameOnAccount, 'ownerType': ownerType, 'bankName': bankName, 'accessToAdmins': accessToAdmins, 'default': default, 'chartOfAccountId': chartOfAccountId}
        request_body_data = {k: v for k, v in request_body_data.items() if v is not None}
        url = f'{self.base_url}/v3/funding-accounts/banks/{bankAccountId}'
        query_params = {}
        response = self._patch(url, data=request_body_data, params=query_params)
    ...
    async def list_card_account_users(self, max: int | None=None, sort: str | None=None, filters: str | None=None, page: str | None=None, currentUser: bool | None=None) -> dict[str, Any]:
        """
    ...
    async def list_invoices(self, max: int | None=None, sort: str | None=None, filters: str | None=None, page: str | None=None) -> dict[str, Any]:
        """
    ...
    async def create_invoice(self, customer: Any, invoiceLineItems: list[dict[str, Any]], invoiceNumber: str | None=None, invoiceDate: str | None=None, dueDate: str | None=None, processingOptions: Any | None=None, payToChartOfAccountId: str | None=None, classifications: Any | None=None) -> dict[str, Any]:
        """
        Create an invoice
        ...
        """
        request_body_data = None
        request_body_data = {'invoiceNumber': invoiceNumber, 'invoiceDate': invoiceDate, 'dueDate': dueDate, 'customer': customer, 'invoiceLineItems': invoiceLineItems, 'processingOptions': processingOptions, 'payToChartOfAccountId': payToChartOfAccountId, 'classifications': classifications}
        request_body_data = {k: v for k, v in request_body_data.items() if v is not None}
        url = f'{self.base_url}/v3/invoices'
        query_params = {}
        response = await self._apost(url, data=request_body_data, params=query_params, content_type='application/json')
    ...
    async def record_invoice(self, paymentDate: str, paymentType: Any, amount: float, invoices: list[dict[str, Any]], customerId: str | None=None, description: str | None=None) -> dict[str, Any]:
        """
        Record AR payment
        ...
        """
        request_body_data = None
        request_body_data = {'customerId': customerId, 'paymentDate': paymentDate, 'paymentType': paymentType, 'amount': amount, 'description': description, 'invoices': invoices}
        request_body_data = {k: v for k, v in request_body_data.items() if v is not None}
    ...
    async def replace_invoice(self, invoiceId: str, customer: Any, invoiceLineItems: list[dict[str, Any]], invoiceNumber: str | None=None, invoiceDate: str | None=None, dueDate: str | None=None, processingOptions: Any | None=None, payToChartOfAccountId: str | None=None, classifications: Any | None=None) -> dict[str, Any]:
        """
        Replace an invoice
    ...
    async def update_invoice(self, invoiceId: str, invoiceNumber: str | None=None, invoiceDate: str | None=None, dueDate: str | None=None, customer: Any | None=None, invoiceLineItems: list[dict[str, Any]] | None=None, processingOptions: Any | None=None, payToChartOfAccountId: str | None=None, classifications: Any | None=None) -> dict[str, Any]:
        """
        Update an invoice
    ...
    async def login(self, devKey: str, username: str, password: str, organizationId: str, rememberMeId: str | None=None, device: str | None=None) -> dict[str, Any]:
        """
        API login
        ...
        """
        request_body_data = None
        request_body_data = {'devKey': devKey, 'username': username, 'password': password, 'organizationId': organizationId, 'rememberMeId': rememberMeId, 'device': device}
        request_body_data = {k: v for k, v in request_body_data.items() if v is not None}
    ...
    async def validate_challenge(self, challengeId: str, token: str, device: str | None=None, machineName: str | None=None, rememberMe: bool | None=None) -> dict[str, Any]:
        """
        ...
        """
        request_body_data = None
        request_body_data = {'challengeId': challengeId, 'token': token, 'device': device, 'machineName': machineName, 'rememberMe': rememberMe}
        request_body_data = {k: v for k, v in request_body_data.items() if v is not None}
    ...
    async def search(self, name: str, scope: Any | None=None, zipOrPostalCode: str | None=None, accountNumber: str | None=None) -> dict[str, Any]:
        """
    ...
    async def create_customer_invitation(self, customerId: str, networkId: str, networkType: Any, rppsInformation: Any | None=None) -> Any:
        """
    ...
    async def update_organization(self, organizationId: str, name: str | None=None, address: Any | None=None, mailingAddress: Any | None=None, phone: str | None=None, companyOwner: Any | None=None, taxId: str | None=None, taxIdType: Any | None=None, industry: str | None=None, businessCategory: Any | None=None, accountType: Any | None=None, processingOptions: Any | None=None) -> dict[str, Any]:
        """
        ...
        if organizationId is None:
            raise ValueError("Missing required parameter 'organizationId'.")
        request_body_data = None
        request_body_data = {'name': name, 'address': address, 'mailingAddress': mailingAddress, 'phone': phone, 'companyOwner': companyOwner, 'taxId': taxId, 'taxIdType': taxIdType, 'industry': industry, 'businessCategory': businessCategory, 'accountType': accountType, 'processingOptions': processingOptions}
        request_body_data = {k: v for k, v in request_body_data.items() if v is not None}
        url = f'{self.base_url}/v3/organizations/{organizationId}'
        query_params = {}
        response = self._patch(url, data=request_body_data, params=query_params)
    ...
    async def login_as_user(self, userId: str, organizationId: str, rememberMeId: str | None=None, device: str | None=None) -> dict[str, Any]:
        """
        API login as user
    ...
    async def list_partner_organizations(self, max: int | None=None, sort: str | None=None, filters: str | None=None, page: str | None=None) -> dict[str, Any]:
        """
    ...
    async def create_organization(self, name: str, address: Any, mailingAddress: Any | None=None, phone: str | None=None, companyOwner: Any | None=None, taxId: str | None=None, taxIdType: Any | None=None, industry: str | None=None, businessCategory: Any | None=None, accountType: Any | None=None, processingOptions: Any | None=None) -> dict[str, Any]:
        """
    ...
    async def list_partner_user_roles(self, max: int | None=None, sort: str | None=None, filters: str | None=None, page: str | None=None) -> dict[str, Any]:
        """
    ...
    async def list_partner_users(self, max: int | None=None, sort: str | None=None, filters: str | None=None, page: str | None=None) -> dict[str, Any]:
        """
        Get list of users
    ...
    async def create_partner_user(self, firstName: str, email: str, username: str, acceptTermsOfService: bool, lastName: str | None=None, roleId: str | None=None, externalReferenceId: str | None=None) -> dict[str, Any]:
        """
        Create a user
        ...
        """
        request_body_data = None
        request_body_data = {'firstName': firstName, 'lastName': lastName, 'email': email, 'roleId': roleId, 'username': username, 'externalReferenceId': externalReferenceId, 'acceptTermsOfService': acceptTermsOfService}
        request_body_data = {k: v for k, v in request_body_data.items() if v is not None}
        url = f'{self.base_url}/v3/partner/users'
        query_params = {}
        response = await self._apost(url, data=request_body_data, params=query_params, content_type='application/json')
    ...
    async def update_partner_user(self, userId: str, firstName: str | None=None, lastName: str | None=None, email: str | None=None, roleId: str | None=None) -> dict[str, Any]:
        """
        Update a user
    ...
    async def list_payments(self, max: int | None=None, sort: str | None=None, filters: str | None=None, page: str | None=None) -> dict[str, Any]:
        """
    ...
    async def create_payment(self, fundingAccount: Any, amount: float, processingOptions: Any, vendorId: str | None=None, billId: str | None=None, description: str | None=None, processDate: str | None=None, paymentPurpose: Any | None=None, transactionNumber: str | None=None, cardFundingPurpose: str | None=None) -> dict[str, Any]:
        """
        Create a payment
        ...
        * If `vendorId` is not set, the bill’s `vendorId` is automatically set.
        ...
        """
        request_body_data = None
        request_body_data = {'vendorId': vendorId, 'billId': billId, 'description': description, 'processDate': processDate, 'fundingAccount': fundingAccount, 'amount': amount, 'processingOptions': processingOptions, 'paymentPurpose': paymentPurpose, 'transactionNumber': transactionNumber, 'cardFundingPurpose': cardFundingPurpose}
        request_body_data = {k: v for k, v in request_body_data.items() if v is not None}
        url = f'{self.base_url}/v3/payments'
        query_params = {}
        response = await self._apost(url, data=request_body_data, params=query_params, content_type='application/json')
    ...
    async def create_bulk_payment(self, fundingAccount: Any, payments: list[dict[str, Any]], vendorId: str | None=None, description: str | None=None, processDate: str | None=None, processingOptions: Any | None=None, transactionNumber: str | None=None, cardFundingPurpose: str | None=None) -> dict[str, Any]:
        """
        ...
        * Do not set `vendorId` when you are paying multiple vendors with one request.
        ...
        """
        request_body_data = None
        request_body_data = {'vendorId': vendorId, 'description': description, 'processDate': processDate, 'fundingAccount': fundingAccount, 'payments': payments, 'processingOptions': processingOptions, 'transactionNumber': transactionNumber, 'cardFundingPurpose': cardFundingPurpose}
        request_body_data = {k: v for k, v in request_body_data.items() if v is not None}
    ...
    async def list_recurring_bills(self, max: int | None=None, sort: str | None=None, filters: str | None=None, page: str | None=None) -> dict[str, Any]:
        """
    ...
    async def create_recurring_bill(self, vendorId: str, schedule: Any, recurringBillLineItems: list[dict[str, Any]], description: str | None=None, processingOptions: Any | None=None, paymentInformation: Any | None=None) -> dict[str, Any]:
        """
        ...
        """
        request_body_data = None
        request_body_data = {'vendorId': vendorId, 'description': description, 'schedule': schedule, 'recurringBillLineItems': recurringBillLineItems, 'processingOptions': processingOptions, 'paymentInformation': paymentInformation}
        request_body_data = {k: v for k, v in request_body_data.items() if v is not None}
        url = f'{self.base_url}/v3/recurringbills'
        query_params = {}
        response = await self._apost(url, data=request_body_data, params=query_params, content_type='application/json')
    ...
    async def replace_recurring_bill(self, recurringBillId: str, vendorId: str, schedule: Any, recurringBillLineItems: list[dict[str, Any]], description: str | None=None, processingOptions: Any | None=None, paymentInformation: Any | None=None) -> dict[str, Any]:
        """
    ...
    async def update_recurring_bill(self, recurringBillId: str, vendorId: str | None=None, description: str | None=None, schedule: Any | None=None, recurringBillLineItems: list[dict[str, Any]] | None=None, processingOptions: Any | None=None, paymentInformation: Any | None=None) -> dict[str, Any]:
        """
    ...
    async def get_vendor_audit_trail(self, vendorId: str, includeArchived: bool | None=None, start: int | None=None, max: int | None=None) -> list[Any]:
        """
    ...
    async def list_organization_user_roles(self, max: int | None=None, sort: str | None=None, filters: str | None=None, page: str | None=None) -> dict[str, Any]:
        """
        Get list of user roles
    ...
    async def list_budgets(self, nextPage: str | None=None, prevPage: str | None=None, max: int | None=None, sort: str | None=None, filters: str | None=None) -> dict[str, Any]:
        """
        Get list of budgets
    ...
    async def create_budget(self, name: str, owners: list[str], recurringInterval: Any, description: str | None=None, members: list[str] | None=None, observers: list[str] | None=None, expirationDate: str | None=None, recurMonth: int | None=None, timezone: str | None=None, autoAddUsers: bool | None=None, receiptRequired: bool | None=None, maxTxSize: float | None=None, carryOver: bool | None=None, parentBudgetId: str | None=None, budgetGroup: bool | None=None, limitlessOverspend: bool | None=None, limit: float | None=None, limitlessGoal: float | None=None, recurringLimit: float | None=None, overspendBuffer: float | None=None, shareFunds: Any | None=None) -> dict[str, Any]:
        """
        Create a budget
        ...
        """
        request_body_data = None
        request_body_data = {'name': name, 'description': description, 'owners': owners, 'members': members, 'observers': observers, 'expirationDate': expirationDate, 'recurringInterval': recurringInterval, 'recurMonth': recurMonth, 'timezone': timezone, 'autoAddUsers': autoAddUsers, 'receiptRequired': receiptRequired, 'maxTxSize': maxTxSize, 'carryOver': carryOver, 'parentBudgetId': parentBudgetId, 'budgetGroup': budgetGroup, 'limitlessOverspend': limitlessOverspend, 'limit': limit, 'limitlessGoal': limitlessGoal, 'recurringLimit': recurringLimit, 'overspendBuffer': overspendBuffer, 'shareFunds': shareFunds}
        request_body_data = {k: v for k, v in request_body_data.items() if v is not None}
        url = f'{self.base_url}/v3/spend/budgets'
        query_params = {}
        response = await self._apost(url, data=request_body_data, params=query_params, content_type='application/json')
    ...
    async def update_budget(self, budgetId: str, name: str | None=None, description: str | None=None, expirationDate: str | None=None, recurringInterval: Any | None=None, recurMonth: int | None=None, timezone: str | None=None, autoAddUsers: bool | None=None, receiptRequired: bool | None=None, maxTxSize: float | None=None, carryOver: bool | None=None, limitlessOverspend: bool | None=None, limit: float | None=None, limitlessGoal: float | None=None, recurringLimit: float | None=None, overspendBuffer: float | None=None, shareFunds: Any | None=None) -> dict[str, Any]:
        """
        Update a budget
        ...
        if budgetId is None:
            raise ValueError("Missing required parameter 'budgetId'.")
        request_body_data = None
        request_body_data = {'name': name, 'description': description, 'expirationDate': expirationDate, 'recurringInterval': recurringInterval, 'recurMonth': recurMonth, 'timezone': timezone, 'autoAddUsers': autoAddUsers, 'receiptRequired': receiptRequired, 'maxTxSize': maxTxSize, 'carryOver': carryOver, 'limitlessOverspend': limitlessOverspend, 'limit': limit, 'limitlessGoal': limitlessGoal, 'recurringLimit': recurringLimit, 'overspendBuffer': overspendBuffer, 'shareFunds': shareFunds}
        request_body_data = {k: v for k, v in request_body_data.items() if v is not None}
        url = f'{self.base_url}/v3/spend/budgets/{budgetId}'
        query_params = {}
        response = self._patch(url, data=request_body_data, params=query_params)
    ...
    async def list_budget_members(self, budgetId: str, max: int | None=None, nextPage: str | None=None, prevPage: str | None=None, sort: str | None=None, filters: str | None=None) -> dict[str, Any]:
        """
    ...
    async def upsert_budget_member(self, budgetId: str, userId: str, limit: float | None=None, recurringLimit: float | None=None, role: Any | None=None, shareBudgetFunds: bool | None=None) -> dict[str, Any]:
        """
    ...
    async def list_cards(self, nextPage: str | None=None, prevPage: str | None=None, max: int | None=None, sort: str | None=None, filters: str | None=None) -> dict[str, Any]:
        """
        Get list of cards
    ...
    async def create_budget_card(self, name: str, userId: str, budgetId: str, limit: float | None=None, recurringLimit: float | None=None, expirationDate: str | None=None, shareBudgetFunds: bool | None=None) -> dict[str, Any]:
        """
        ...
        """
        request_body_data = None
        request_body_data = {'name': name, 'userId': userId, 'budgetId': budgetId, 'limit': limit, 'recurringLimit': recurringLimit, 'expirationDate': expirationDate, 'shareBudgetFunds': shareBudgetFunds}
        request_body_data = {k: v for k, v in request_body_data.items() if v is not None}
        url = f'{self.base_url}/v3/spend/cards'
        query_params = {}
        response = await self._apost(url, data=request_body_data, params=query_params, content_type='application/json')
    ...
    async def update_card(self, cardId: str, name: str | None=None, budgetId: str | None=None, limit: float | None=None, recurringLimit: float | None=None, expirationDate: str | None=None, shareBudgetFunds: bool | None=None, recurring: bool | None=None) -> dict[str, Any]:
        """
        ...
        if cardId is None:
            raise ValueError("Missing required parameter 'cardId'.")
        request_body_data = None
        request_body_data = {'name': name, 'budgetId': budgetId, 'limit': limit, 'recurringLimit': recurringLimit, 'expirationDate': expirationDate, 'shareBudgetFunds': shareBudgetFunds, 'recurring': recurring}
        request_body_data = {k: v for k, v in request_body_data.items() if v is not None}
        url = f'{self.base_url}/v3/spend/cards/{cardId}'
        query_params = {}
        response = self._patch(url, data=request_body_data, params=query_params)
    ...
    async def list_custom_fields(self, max: int | None=None, nextPage: str | None=None, prevPage: str | None=None, sort: str | None=None, filters: str | None=None) -> dict[str, Any]:
        """
    ...
    async def create_custom_field(self, name: str, allowCustomValues: bool, required: bool, global_: bool, description: str | None=None, multiSelect: bool | None=None, minimumAmountForRequirement: float | None=None, values: list[str] | None=None, selectedBudgetIds: list[str] | None=None, requiredBudgetIds: list[str] | None=None) -> dict[str, Any]:
        """
        Create custom field
        ...
        """
        request_body_data = None
        request_body_data = {'name': name, 'description': description, 'multiSelect': multiSelect, 'allowCustomValues': allowCustomValues, 'minimumAmountForRequirement': minimumAmountForRequirement, 'required': required, 'global': global_, 'values': values, 'selectedBudgetIds': selectedBudgetIds, 'requiredBudgetIds': requiredBudgetIds}
        request_body_data = {k: v for k, v in request_body_data.items() if v is not None}
        url = f'{self.base_url}/v3/spend/custom-fields'
        query_params = {}
        response = await self._apost(url, data=request_body_data, params=query_params, content_type='application/json')
    ...
    async def update_custom_field(self, customFieldId: str, name: str | None=None, description: str | None=None, allowCustomValues: bool | None=None, minimumAmountForRequirement: float | None=None, required: bool | None=None, global_: bool | None=None, selectedBudgetIds: list[str] | None=None, requiredBudgetIds: list[str] | None=None) -> dict[str, Any]:
        """
        ...
        if customFieldId is None:
            raise ValueError("Missing required parameter 'customFieldId'.")
        request_body_data = None
        request_body_data = {'name': name, 'description': description, 'allowCustomValues': allowCustomValues, 'minimumAmountForRequirement': minimumAmountForRequirement, 'required': required, 'global': global_, 'selectedBudgetIds': selectedBudgetIds, 'requiredBudgetIds': requiredBudgetIds}
        request_body_data = {k: v for k, v in request_body_data.items() if v is not None}
        url = f'{self.base_url}/v3/spend/custom-fields/{customFieldId}'
        query_params = {}
        response = self._patch(url, data=request_body_data, params=query_params)
    ...
    async def list_custom_field_values(self, customFieldId: str, max: int | None=None, nextPage: str | None=None, prevPage: str | None=None, filters: str | None=None) -> dict[str, Any]:
        """
    ...
    async def list_reimbursements(self, nextPage: str | None=None, prevPage: str | None=None, max: int | None=None, sort: str | None=None, filters: str | None=None) -> dict[str, Any]:
        """
    ...
    async def create_reimbursement(self, userId: str, budgetId: str, amount: float, note: str, merchantName: str, occurredDate: str, receipts: list[dict[str, Any]], customFields: list[dict[str, Any]] | None=None) -> dict[str, Any]:
        """
        ...
        """
        request_body_data = None
        request_body_data = {'userId': userId, 'budgetId': budgetId, 'amount': amount, 'note': note, 'merchantName': merchantName, 'occurredDate': occurredDate, 'receipts': receipts, 'customFields': customFields}
        request_body_data = {k: v for k, v in request_body_data.items() if v is not None}
        url = f'{self.base_url}/v3/spend/reimbursements'
        query_params = {}
        response = await self._apost(url, data=request_body_data, params=query_params, content_type='application/json')
    ...
    async def update_reimbursement(self, reimbursementId: str, userId: str | None=None, budgetId: str | None=None, amount: float | None=None, note: str | None=None, merchantName: str | None=None, occurredDate: str | None=None, receipts: list[dict[str, Any]] | None=None, customFields: list[dict[str, Any]] | None=None) -> dict[str, Any]:
        """
    ...
    async def list_transactions(self, max: int | None=None, nextPage: str | None=None, prevPage: str | None=None, sort: str | None=None, filters: str | None=None, showCustomFieldIds: str | None=None) -> dict[str, Any]:
        """
    ...
    async def list_transaction_custom_field_values(self, transactionId: str, customFieldId: str, max: int | None=None, nextPage: str | None=None, prevPage: str | None=None) -> dict[str, Any]:
        """
    ...
    async def list_users(self, nextPage: str | None=None, prevPage: str | None=None, max: int | None=None, filters: str | None=None) -> dict[str, Any]:
        """
        Get list of users
    ...
    async def update_user(self, userId: str, firstName: str | None=None, lastName: str | None=None, email: str | None=None, role: Any | None=None, dateOfBirth: str | None=None) -> dict[str, Any]:
        """
        Update a user
    ...
    async def list_organization_users(self, max: int | None=None, sort: str | None=None, filters: str | None=None, page: str | None=None) -> dict[str, Any]:
        """
        Get list of users
    ...
    async def create_organization_user(self, firstName: str, lastName: str, email: str, roleId: str, acceptTermsOfService: bool) -> dict[str, Any]:
        """
        Create a user
        ...
        """
        request_body_data = None
        request_body_data = {'firstName': firstName, 'lastName': lastName, 'email': email, 'roleId': roleId, 'acceptTermsOfService': acceptTermsOfService}
        request_body_data = {k: v for k, v in request_body_data.items() if v is not None}
        url = f'{self.base_url}/v3/users'
        query_params = {}
        response = await self._apost(url, data=request_body_data, params=query_params, content_type='application/json')
    ...
    async def update_organization_user(self, userId: str, firstName: str | None=None, lastName: str | None=None, roleId: str | None=None) -> dict[str, Any]:
        """
        Update a user
    ...
    async def list_vendors(self, max: int | None=None, sort: str | None=None, filters: str | None=None, page: str | None=None) -> dict[str, Any]:
        """
        Get list of vendors
    ...
    async def create_vendor(self, name: str, address: Any, shortName: str | None=None, accountNumber: str | None=None, accountType: Any | None=None, email: str | None=None, phone: str | None=None, paymentInformation: Any | None=None, additionalInfo: Any | None=None, billCurrency: Any | None=None, autoPay: Any | None=None) -> dict[str, Any]:
        """
        Create a vendor
        ...
        """
        request_body_data = None
        request_body_data = {'name': name, 'shortName': shortName, 'accountNumber': accountNumber, 'accountType': accountType, 'email': email, 'phone': phone, 'address': address, 'paymentInformation': paymentInformation, 'additionalInfo': additionalInfo, 'billCurrency': billCurrency, 'autoPay': autoPay}
        request_body_data = {k: v for k, v in request_body_data.items() if v is not None}
        url = f'{self.base_url}/v3/vendors'
        query_params = {}
        response = await self._apost(url, data=request_body_data, params=query_params, content_type='application/json')
    ...
    async def update_vendor(self, vendorId: str, name: str | None=None, shortName: str | None=None, accountNumber: str | None=None, accountType: Any | None=None, email: str | None=None, phone: str | None=None, address: Any | None=None, paymentInformation: Any | None=None, additionalInfo: Any | None=None, billCurrency: Any | None=None, autoPay: Any | None=None) -> dict[str, Any]:
        """
        Update a vendor
    ...
    async def create_vendor_bank_account(self, vendorId: str, accountNumber: str, nameOnAccount: str | None=None, routingNumber: str | None=None, type: Any | None=None, ownerType: Any | None=None, regulatoryFields: list[dict[str, Any]] | None=None, paymentCurrency: Any | None=None) -> dict[str, Any]:
        """
        ...
        if vendorId is None:
            raise ValueError("Missing required parameter 'vendorId'.")
        request_body_data = None
        request_body_data = {'nameOnAccount': nameOnAccount, 'accountNumber': accountNumber, 'routingNumber': routingNumber, 'type': type, 'ownerType': ownerType, 'regulatoryFields': regulatoryFields, 'paymentCurrency': paymentCurrency}
        request_body_data = {k: v for k, v in request_body_data.items() if v is not None}
        url = f'{self.base_url}/v3/vendors/{vendorId}/bank-account'
        query_params = {}
        response = await self._apost(url, data=request_body_data, params=query_params, content_type='application/json')
    ...
    def list_tools(self):
        return [self.list_customer_attachments, self.create_customer_attachment, self.list_invoice_attachments, self.create_invoice_attachment, self.list_vendor_attachments, self.create_vendor_attachment, self.get_attachment, self.list_bills, self.create_bill, self.create_bulk_bills, self.get_bill, self.replace_bill, self.update_bill, self.archive_bill, self.restore_bill, self.list_classification_accounting_classes, self.create_classification_accounting_class, self.bulk_create_classification_accounting_class, self.bulk_update_classification_accounting_class, self.bulk_archive_classification_accounting_class, self.bulk_restore_classification_accounting_class, self.get_classification_accounting_class, self.update_classification_accounting_class, self.archive_classification_accounting_class, self.restore_classification_accounting_class, self.list_classification_chart_of_accounts, self.create_classification_chart_of_accounts, self.bulk_create_classification_chart_of_accounts, self.bulk_update_classification_chart_of_accounts, self.bulk_archive_classification_chart_of_accounts, self.bulk_restore_classification_chart_of_accounts, self.get_classification_chart_of_accounts, self.update_classification_chart_of_accounts, self.archive_classification_chart_of_accounts, self.restore_classification_chart_of_accounts, self.list_classification_departments, self.create_classification_department, self.bulk_create_classification_department, self.bulk_update_classification_department, self.bulk_archive_classification_department, self.bulk_restore_classification_department, self.get_classification_department, self.update_classification_department, self.archive_classification_department, self.restore_classification_department, self.list_classification_employees, self.create_classification_employee, self.bulk_create_classification_employee, self.bulk_update_classification_employee, self.bulk_archive_classification_employee, self.bulk_restore_classification_employee, self.get_classification_employee, self.update_classification_employee, self.archive_classification_employee, self.restore_classification_employee, self.list_classification_items, self.create_classification_item, self.bulk_create_classification_item, self.bulk_update_classification_item, self.bulk_archive_classification_item, self.bulk_restore_classification_item, self.get_classification_item, self.update_classification_item, self.archive_classification_item, self.restore_classification_item, self.list_classification_jobs, self.create_classification_job, self.bulk_create_classification_job, self.bulk_update_classification_job, self.bulk_archive_classification_job, self.bulk_restore_classification_job, self.get_classification_job, self.update_classification_job, self.archive_classification_job, self.restore_classification_job, self.list_classification_locations, self.create_classification_location, self.bulk_create_classification_location, self.bulk_update_classification_location, self.bulk_archive_classification_location, self.bulk_restore_classification_location, self.get_classification_location, self.update_classification_location, self.archive_classification_location, self.restore_classification_location, self.list_customers, self.create_customer, self.get_customer, self.update_customer, self.archive_customer, self.restore_customer, self.list_documents, self.create_bill_document, self.upload_status, self.get_document, self.list_payable_apcards, self.list_bank_accounts, self.create_bank_account, self.list_bank_account_users, self.nominate_bank_account_user, self.archive_bank_account_user, self.get_bank_account, self.update_bank_account, self.archive_bank_account, self.verify_bank_account, self.list_payable_card_accounts, self.list_card_funding_purposes, self.list_card_account_users, self.get_card_account, self.get_funding_account_permission, self.get_health_check, self.list_invoices, self.create_invoice, self.record_invoice, self.get_invoice, self.replace_invoice, self.update_invoice, self.archive_invoice, self.send_invoice, self.restore_invoice, self.login, self.get_session_info, self.logout, self.generate_challenge, self.validate_challenge, self.list_mfa_phones, self.setup, self.validate, self.step_up_session, self.search, self.accept_invitation, self.get_customer_invitation, self.create_customer_invitation, self.delete_customer_invitation, self.get_vendor_invitation, self.create_vendor_invitation, self.delete_vendor_invitation, self.list_industries, self.get_organization, self.update_organization, self.get_price_plan, self.partner_login, self.login_as_user, self.list_partner_organizations, self.create_organization, self.create_phone, self.list_partner_user_roles, self.get_partner_user_role, self.list_partner_users, self.create_partner_user, self.get_partner_user, self.update_partner_user, self.archive_partner_user, self.restore_partner_user, self.list_payments, self.create_payment, self.create_bulk_payment, self.list_payment_options, self.get_payment, self.cancel_payment, self.get_check_image_data, self.void_payment, self.list_recurring_bills, self.create_recurring_bill, self.get_recurring_bill, self.replace_recurring_bill, self.update_recurring_bill, self.archive_recurring_bill, self.restore_recurring_bill, self.get_vendor_audit_trail, self.get_risk_verifications, self.initiate_risk_verifications, self.get_risk_verification_phone, self.create_risk_verification_phone, self.list_organization_user_roles, self.get_organization_user_role, self.list_budgets, self.create_budget, self.get_budget, self.delete_budget, self.update_budget, self.list_budget_members, self.upsert_bulk_budget_users, self.get_budget_member, self.upsert_budget_member, self.delete_budget_member, self.list_cards, self.create_budget_card, self.get_card, self.delete_card, self.update_card, self.get_pan_jwt, self.list_custom_fields, self.create_custom_field, self.get_custom_field, self.delete_custom_field, self.update_custom_field, self.list_custom_field_values, self.create_custom_field_values, self.delete_custom_field_value, self.get_custom_field_values, self.list_reimbursements, self.create_reimbursement, self.create_image_upload_url, self.get_reimbursement, self.delete_reimbursement, self.update_reimbursement, self.approve_or_deny_reimbursement, self.list_transactions, self.get_transaction, self.update_transaction, self.list_transaction_custom_fields, self.update_transaction_custom_fields, self.list_transaction_custom_field_values, self.list_users, self.create_user, self.get_current_user, self.get_user, self.delete_user, self.update_user, self.list_organization_users, self.create_organization_user, self.get_organization_user, self.update_organization_user, self.archive_organization_user, self.restore_organization_user, self.list_vendors, self.create_vendor, self.create_bulk_vendor, self.get_intl_config, self.get_vendor, self.update_vendor, self.archive_vendor, self.get_vendor_bank_account, self.create_vendor_bank_account, self.delete_vendor_bank_account, self.get_configuration_by_vendor_id, self.restore_vendor]