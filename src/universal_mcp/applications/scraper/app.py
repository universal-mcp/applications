...
class ScraperApp(APIApplication):
    ...
    def linkedin_post_search(
        ...
        """
        Performs a general LinkedIn search for posts using keywords and filters like content type. It supports pagination and can utilize either the 'classic' or 'sales_navigator' API, searching broadly across the platform.
    ...
    def linkedin_people_search(
        ...
        """
        Performs a LinkedIn people search using keywords.

        Args:
            cursor: Pagination cursor for the next page of entries.
            limit: Number of items to return.
            keywords: Keywords to search for people (e.g., "software engineer in London").
        ...
        Tags:
            linkedin, people, search, scraper, api, important
        """
        return self._unipile_app.search(
            account_id=self.account_id,
            category="people",
    ...
    def linkedin_company_search(
        ...
        """
        Performs a LinkedIn company search using keywords.

        Args:
            cursor: Pagination cursor for the next page of entries.
            limit: Number of items to return.
            keywords: Keywords to search for companies (e.g., "fintech startup in London").
        ...
        Tags:
            linkedin, companies, search, scraper, api, important
        """
        return self._unipile_app.search(
            account_id=self.account_id,
            category="companies",
