...
class GoogleDriveApp(APIApplication):
    ...
    async def move_file(self, file_id: str, add_parents: str, remove_parents: str) -> dict[str, Any]:
        ...
        response = await self._async_patch(url, params=params, data=data)
    ...
    async def create_text_file(
        ...
        create_response = await self._async_post(create_url, data=metadata)
    ...
    async def find_folder_id_by_name(self, folder_name: str) -> str | None:
        ...
        try:
            response = await self._async_get(f"{self.base_url}/files", params={"q": query, "fields": "files(id,name)"})
    ...
    async def create_folder(self, folder_name: str, parent_id: str = None) -> dict[str, Any]:
        ...
        response = await self._async_post(url, data=metadata, params=params)
        return response.json()
