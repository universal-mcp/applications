...
class OnedriveApp(APIApplication):
    ...
    def list_tools(self):
        return [self.get_drive_info, self.search_files, self.get_item_metadata, self.create_folder, self.delete_item, self.download_file, self.upload_file, self.get_my_profile, self.list_folders, self.list_files, self.create_folder_and_list, self.upload_text_file, self.get_document_content]