...
class MsTeamsApp(APIApplication):
    ...
    async def get_user_chats(self, top: int | None=None, skip: int | None=None, search: str | None=None, filter: str | None=None, count: bool | None=None, orderby: list[str] | None=None, select: list[str] | None=None, expand: list[str] | None=None) -> dict[str, Any]:
        """
    ...
    async def list_channels_for_team(self, team_id: str, top: int | None=None, skip: int | None=None, search: str | None=None, filter: str | None=None, count: bool | None=None, orderby: list[str] | None=None, select: list[str] | None=None, expand: list[str] | None=None) -> dict[str, Any]:
        """
    ...
    async def create_chat(self, id: str | None=None, chatType: str | None=None, createdDateTime: str | None=None, isHiddenForAllMembers: bool | None=None, lastUpdatedDateTime: str | None=None, onlineMeetingInfo: dict[str, dict[str, Any]] | None=None, tenantId: str | None=None, topic: str | None=None, viewpoint: dict[str, dict[str, Any]] | None=None, webUrl: str | None=None, installedApps: list[Any] | None=None, lastMessagePreview: Any | None=None, members: list[Any] | None=None, messages: list[Any] | None=None, permissionGrants: list[Any] | None=None, pinnedMessages: list[Any] | None=None, tabs: list[Any] | None=None) -> Any:
        """
        ...
        request_body_data = {'id': id, 'chatType': chatType, 'createdDateTime': createdDateTime, 'isHiddenForAllMembers': isHiddenForAllMembers, 'lastUpdatedDateTime': lastUpdatedDateTime, 'onlineMeetingInfo': onlineMeetingInfo, 'tenantId': tenantId, 'topic': topic, 'viewpoint': viewpoint, 'webUrl': webUrl, 'installedApps': installedApps, 'lastMessagePreview': lastMessagePreview, 'members': members, 'messages': messages, 'permissionGrants': permissionGrants, 'pinnedMessages': pinnedMessages, 'tabs': tabs}
    ...
    async def update_chat_details(self, chat_id: str, id: str | None=None, chatType: str | None=None, createdDateTime: str | None=None, isHiddenForAllMembers: bool | None=None, lastUpdatedDateTime: str | None=None, onlineMeetingInfo: dict[str, dict[str, Any]] | None=None, tenantId: str | None=None, topic: str | None=None, viewpoint: dict[str, dict[str, Any]] | None=None, webUrl: str | None=None, installedApps: list[Any] | None=None, lastMessagePreview: Any | None=None, members: list[Any] | None=None, messages: list[Any] | None=None, permissionGrants: list[Any] | None=None, pinnedMessages: list[Any] | None=None, tabs: list[Any] | None=None) -> Any:
        """
    ...
    async def list_installed_chat_apps(self, chat_id: str, top: int | None=None, skip: int | None=None, search: str | None=None, filter: str | None=None, count: bool | None=None, orderby: list[str] | None=None, select: list[str] | None=None, expand: list[str] | None=None) -> dict[str, Any]:
        """
    ...
    async def list_chat_members(self, chat_id: str, top: int | None=None, skip: int | None=None, search: str | None=None, filter: str | None=None, count: bool | None=None, orderby: list[str] | None=None, select: list[str] | None=None, expand: list[str] | None=None) -> dict[str, Any]:
        """
    ...
    async def add_member_to_chat(self, chat_id: str, id: str | None=None, displayName: str | None=None, roles: list[str] | None=None, visibleHistoryStartDateTime: str | None=None) -> Any:
        """
        ...
        if chat_id is None:
            raise ValueError("Missing required parameter 'chat-id'.")
        request_body_data = None
        request_body_data = {'id': id, 'displayName': displayName, 'roles': roles, 'visibleHistoryStartDateTime': visibleHistoryStartDateTime}
        request_body_data = {k: v for k, v in request_body_data.items() if v is not None}
        url = f'{self.base_url}/chats/{chat_id}/members'
        query_params = {}
        response = await self._apost(url, data=request_body_data, params=query_params, content_type='application/json')
    ...
    async def get_chat_member(self, chat_id: str, conversationMember_id: str, select: list[str] | None=None, expand: list[str] | None=None) -> Any:
        """
    ...
    async def list_chat_messages(self, chat_id: str, top: int | None=None, skip: int | None=None, search: str | None=None, filter: str | None=None, count: bool | None=None, orderby: list[str] | None=None, select: list[str] | None=None, expand: list[str] | None=None) -> dict[str, Any]:
        """
    ...
    async def get_chat_message(self, chat_id: str, chatMessage_id: str, select: list[str] | None=None, expand: list[str] | None=None) -> Any:
        """
    ...
    async def list_chat_message_replies(self, chat_id: str, chatMessage_id: str, top: int | None=None, skip: int | None=None, search: str | None=None, filter: str | None=None, count: bool | None=None, orderby: list[str] | None=None, select: list[str] | None=None, expand: list[str] | None=None) -> dict[str, Any]:
        """
    ...
    async def reply_to_chat_message(self, chat_id: str, chatMessage_id: str, id: str | None=None, attachments: list[dict[str, dict[str, Any]]] | None=None, body: dict[str, dict[str, Any]] | None=None, channelIdentity: dict[str, dict[str, Any]] | None=None, chatId: str | None=None, createdDateTime: str | None=None, deletedDateTime: str | None=None, etag: str | None=None, eventDetail: dict[str, dict[str, Any]] | None=None, from_: Any | None=None, importance: str | None=None, lastEditedDateTime: str | None=None, lastModifiedDateTime: str | None=None, locale: str | None=None, mentions: list[dict[str, dict[str, Any]]] | None=None, messageHistory: list[dict[str, dict[str, Any]]] | None=None, messageType: str | None=None, policyViolation: dict[str, dict[str, Any]] | None=None, reactions: list[dict[str, dict[str, Any]]] | None=None, replyToId: str | None=None, subject: str | None=None, summary: str | None=None, webUrl: str | None=None, hostedContents: list[Any] | None=None, replies: list[Any] | None=None) -> Any:
        """
        ...
        if chatMessage_id is None:
            raise ValueError("Missing required parameter 'chatMessage-id'.")
        request_body_data = None
        request_body_data = {'id': id, 'attachments': attachments, 'body': body, 'channelIdentity': channelIdentity, 'chatId': chatId, 'createdDateTime': createdDateTime, 'deletedDateTime': deletedDateTime, 'etag': etag, 'eventDetail': eventDetail, 'from': from_, 'importance': importance, 'lastEditedDateTime': lastEditedDateTime, 'lastModifiedDateTime': lastModifiedDateTime, 'locale': locale, 'mentions': mentions, 'messageHistory': messageHistory, 'messageType': messageType, 'policyViolation': policyViolation, 'reactions': reactions, 'replyToId': replyToId, 'subject': subject, 'summary': summary, 'webUrl': webUrl, 'hostedContents': hostedContents, 'replies': replies}
        request_body_data = {k: v for k, v in request_body_data.items() if v is not None}
        url = f'{self.base_url}/chats/{chat_id}/messages/{chatMessage_id}/replies'
        query_params = {}
        response = await self._apost(url, data=request_body_data, params=query_params, content_type='application/json')
    ...
    async def get_chat_reply_details(self, chat_id: str, chatMessage_id: str, chatMessage_id1: str, select: list[str] | None=None, expand: list[str] | None=None) -> Any:
        """
    ...
    async def create_team_from_group(self, group_id: str, id: str | None=None, classification: str | None=None, createdDateTime: str | None=None, description: str | None=None, displayName: str | None=None, firstChannelName: str | None=None, funSettings: dict[str, dict[str, Any]] | None=None, guestSettings: dict[str, dict[str, Any]] | None=None, internalId: str | None=None, isArchived: bool | None=None, memberSettings: dict[str, dict[str, Any]] | None=None, messagingSettings: dict[str, dict[str, Any]] | None=None, specialization: str | None=None, summary: dict[str, dict[str, Any]] | None=None, tenantId: str | None=None, visibility: str | None=None, webUrl: str | None=None, allChannels: list[Any] | None=None, channels: list[Any] | None=None, group: Any | None=None, incomingChannels: list[Any] | None=None, installedApps: list[Any] | None=None, members: list[Any] | None=None, operations: list[Any] | None=None, permissionGrants: list[Any] | None=None, photo: Any | None=None, primaryChannel: Any | None=None, schedule: Any | None=None, tags: list[Any] | None=None, template: Any | None=None) -> Any:
        """
        ...
        request_body_data = None
        request_body_data = {'id': id, 'classification': classification, 'createdDateTime': createdDateTime, 'description': description, 'displayName': displayName, 'firstChannelName': firstChannelName, 'funSettings': funSettings, 'guestSettings': guestSettings, 'internalId': internalId, 'isArchived': isArchived, 'memberSettings': memberSettings, 'messagingSettings': messagingSettings, 'specialization': specialization, 'summary': summary, 'tenantId': tenantId, 'visibility': visibility, 'webUrl': webUrl, 'allChannels': allChannels, 'channels': channels, 'group': group, 'incomingChannels': incomingChannels, 'installedApps': installedApps, 'members': members, 'operations': operations, 'permissionGrants': permissionGrants, 'photo': photo, 'primaryChannel': primaryChannel, 'schedule': schedule, 'tags': tags, 'template': template}
        request_body_data = {k: v for k, v in request_body_data.items() if v is not None}
    ...
    async def create_team(self, id: str | None=None, classification: str | None=None, createdDateTime: str | None=None, description: str | None=None, displayName: str | None=None, firstChannelName: str | None=None, funSettings: dict[str, dict[str, Any]] | None=None, guestSettings: dict[str, dict[str, Any]] | None=None, internalId: str | None=None, isArchived: bool | None=None, memberSettings: dict[str, dict[str, Any]] | None=None, messagingSettings: dict[str, dict[str, Any]] | None=None, specialization: str | None=None, summary: dict[str, dict[str, Any]] | None=None, tenantId: str | None=None, visibility: str | None=None, webUrl: str | None=None, allChannels: list[Any] | None=None, channels: list[Any] | None=None, group: Any | None=None, incomingChannels: list[Any] | None=None, installedApps: list[Any] | None=None, members: list[Any] | None=None, operations: list[Any] | None=None, permissionGrants: list[Any] | None=None, photo: Any | None=None, primaryChannel: Any | None=None, schedule: Any | None=None, tags: list[Any] | None=None, template: Any | None=None) -> Any:
        """
    ...
    async def get_channel_details(self, team_id: str, channel_id: str, select: list[str] | None=None, expand: list[str] | None=None) -> Any:
        """
    ...
    async def update_channel_message(self, team_id: str, channel_id: str, chatMessage_id: str, id: str | None=None, attachments: list[dict[str, dict[str, Any]]] | None=None, body: dict[str, dict[str, Any]] | None=None, channelIdentity: dict[str, dict[str, Any]] | None=None, chatId: str | None=None, createdDateTime: str | None=None, deletedDateTime: str | None=None, etag: str | None=None, eventDetail: dict[str, dict[str, Any]] | None=None, from_: Any | None=None, importance: str | None=None, lastEditedDateTime: str | None=None, lastModifiedDateTime: str | None=None, locale: str | None=None, mentions: list[dict[str, dict[str, Any]]] | None=None, messageHistory: list[dict[str, dict[str, Any]]] | None=None, messageType: str | None=None, policyViolation: dict[str, dict[str, Any]] | None=None, reactions: list[dict[str, dict[str, Any]]] | None=None, replyToId: str | None=None, subject: str | None=None, summary: str | None=None, webUrl: str | None=None, hostedContents: list[Any] | None=None, replies: list[Any] | None=None) -> Any:
        """
    ...
    async def update_channel_message_reply(self, team_id: str, channel_id: str, chatMessage_id: str, chatMessage_id1: str, id: str | None=None, attachments: list[dict[str, dict[str, Any]]] | None=None, body: dict[str, dict[str, Any]] | None=None, channelIdentity: dict[str, dict[str, Any]] | None=None, chatId: str | None=None, createdDateTime: str | None=None, deletedDateTime: str | None=None, etag: str | None=None, eventDetail: dict[str, dict[str, Any]] | None=None, from_: Any | None=None, importance: str | None=None, lastEditedDateTime: str | None=None, lastModifiedDateTime: str | None=None, locale: str | None=None, mentions: list[dict[str, dict[str, Any]]] | None=None, messageHistory: list[dict[str, dict[str, Any]]] | None=None, messageType: str | None=None, policyViolation: dict[str, dict[str, Any]] | None=None, reactions: list[dict[str, dict[str, Any]]] | None=None, replyToId: str | None=None, subject: str | None=None, summary: str | None=None, webUrl: str | None=None, hostedContents: list[Any] | None=None, replies: list[Any] | None=None) -> Any:
        """
    ...
    async def list_channel_tabs(self, team_id: str, channel_id: str, top: int | None=None, skip: int | None=None, search: str | None=None, filter: str | None=None, count: bool | None=None, orderby: list[str] | None=None, select: list[str] | None=None, expand: list[str] | None=None) -> dict[str, Any]:
        """
    ...
    async def create_channel_tab(self, team_id: str, channel_id: str, id: str | None=None, configuration: dict[str, dict[str, Any]] | None=None, displayName: str | None=None, webUrl: str | None=None, teamsApp: Any | None=None) -> Any:
        """
    ...
    async def get_channel_tab_details(self, team_id: str, channel_id: str, teamsTab_id: str, select: list[str] | None=None, expand: list[str] | None=None) -> Any:
        """
    ...
    async def update_channel_tab(self, team_id: str, channel_id: str, teamsTab_id: str, id: str | None=None, configuration: dict[str, dict[str, Any]] | None=None, displayName: str | None=None, webUrl: str | None=None, teamsApp: Any | None=None) -> Any:
        """
    ...
    async def list_user_installed_apps(self, user_id: str, top: int | None=None, skip: int | None=None, search: str | None=None, filter: str | None=None, count: bool | None=None, orderby: list[str] | None=None, select: list[str] | None=None, expand: list[str] | None=None) -> dict[str, Any]:
        """
    ...
    def list_tools(self):
        return [self.get_user_chats, self.get_joined_teams, self.list_channels_for_team, self.send_chat_message, self.send_channel_message, self.reply_to_channel_message, self.create_chat, self.get_chat_details, self.update_chat_details, self.list_installed_chat_apps, self.list_chat_members, self.add_member_to_chat, self.get_chat_member, self.delete_chat_member, self.list_chat_messages, self.get_chat_message, self.list_chat_message_replies, self.reply_to_chat_message, self.get_chat_reply_details, self.create_team_from_group, self.create_team, self.get_channel_details, self.update_channel_message, self.update_channel_message_reply, self.list_channel_tabs, self.create_channel_tab, self.get_channel_tab_details, self.update_channel_tab, self.delete_channel_tab, self.get_primary_team_channel, self.list_user_installed_apps]